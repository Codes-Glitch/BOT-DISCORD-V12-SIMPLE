...
*/
      ...
      case "prefix": {
        ...
        let Prefix = await db.fetch(`refix_${message.guild.id}`);
        ...
        if (!NewPrefix)
          return message.channel.send("Please Give New Prefix Of Bot!");

        if (NewPrefix.length > 10)
          return message.channel.send("Too Long Prefix - 10 Limit");
        ...
        try {
          ...
          return message.channel.send(
            `New Prefix Has Been Setted - ${NewPrefix}`
          );
        }
      }
    }
